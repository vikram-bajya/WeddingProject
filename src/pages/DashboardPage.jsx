      ...
      <aside className="w-[260px] flex-shrink-0 bg-[#FFF7FA] border-r border-gray-200 h-screen sticky top-0 flex flex-col hidden md:flex">
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-200">
          <Link to="/" className="flex items-center gap-2 no-underline">
            ...
            <span style={{ fontFamily: "'Playfair Display', serif", color: '#66D0BC', fontSize: '1.25rem', fontWeight: 700 }}>WeddingBliss</span>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <Link to="/" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold text-rose-600 hover:bg-[#FF3E9B]/10 transition-colors">
      ...
      <main className="flex-1 flex flex-col overflow-hidden max-w-full">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-10">
          <div className="flex-1 md:hidden">
            <span style={{ fontFamily: "'Playfair Display', serif", color: '#FF3E9B', fontSize: '1.2rem', fontWeight: 700 }}>Dashboard</span>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8">
          ...
          {/* Greeting */}
          <div className="mb-8">
            <h1 style={{ fontFamily: "'Playfair Display', serif", color: '#FF3E9B', fontSize: '2.25rem', fontWeight: 700 }}>Good Morning, Priya! ☀️</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="card p-5 lg:p-6">
              ...
              <div className="w-full bg-gray-100 rounded-full h-2">
                <div className="bg-[#FF3E9B] h-2 rounded-full" style={{ width: '65%' }}></div>
              </div>
            </div>

            <div className="card p-5 lg:p-6 text-white" style={{ background: 'linear-gradient(135deg, #f0d060, #66D0BC)' }}>
              <p className="text-sm font-semibold text-[#3A8B95] uppercase tracking-wider mb-1">Days to Wedding</p>
              <p className="text-3xl font-bold text-white mb-1 shadow-sm">87 Days</p>
              <p className="text-xs text-[#3A8B95] font-medium">June 15, 2025</p>
            </div>
          </div>
          ...
          <div className="card mb-8">
            <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
              ...
              <a href="#" className="text-sm font-semibold text-[#FF3E9B] hover:underline">View All</a>
            </div>
                  ...
                  <div key={i} className="border border-gray-100 rounded-lg overflow-hidden group">
                    ...
                    <div className="p-3 relative">
                      ...
                      <div className="flex items-center justify-between mt-1">
                        <span className="text-xs text-[#66D0BC] font-semibold">{v.type}</span>
            ...
            <div className="card p-6 h-full flex flex-col">
              ...
              <div className="flex items-center gap-3 mb-5 mt-1">
                <div className="flex-1 bg-gray-100 rounded-full h-1.5">
                  <div className="bg-[#66D0BC] h-1.5 rounded-full" style={{ width: '65%' }}></div>
                </div>
              ...
              <div className="space-y-1 flex-1">
                {CHECKLIST.map(item => (
                  <label key={item.id} className="flex items-center gap-3 p-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors group text-sm">
                    <div className={`w-5 h-5 rounded border ${item.done ? 'bg-[#FF3E9B] border-[#FF3E9B] text-white flex items-center justify-center' : 'border-gray-300 bg-white group-hover:border-[#FF3E9B]'}`}>
