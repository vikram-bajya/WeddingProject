...
const TESTIMONIALS = [
  {
    ...
    review:
      "WeddingBliss made our dream wedding come true! Found the perfect photographer and venue within our budget. Absolutely stress-free experience!",
  ...
  },
  {
    ...
    review:
      "The vendor selection is incredible. Every vendor is verified and professional. Our caterer was top-notch thanks to WeddingBliss.",
  ...
  },
  {
    ...
    review:
      "From decorator to makeup artist — we found everything here. The enquiry system made it so easy to reach out to vendors directly.",
    ...
    <div className="flex items-center gap-1">
      {[1, 2, 3, 4, 5].map((i) => (
        <span
          key={i}
          className={
            i <= Math.round(rating) ? "text-[#66D0BC]" : "text-gray-300"
          }
          style={{ fontSize: "1rem" }}
        >
          ★
  ...
  return (
    <div className="min-h-screen">
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #3A8B95 0%, #FF3E9B 60%, #9a3550 100%)",
          minHeight: "85vh",
          display: "flex",
          alignItems: "center",
        }}
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 80%, #66D0BC 1px, transparent 1px), radial-gradient(circle at 80% 20%, #66D0BC 1px, transparent 1px)",
        ...
        <div className="relative max-w-4xl mx-auto w-full">
          <div className="inline-block mb-4">
            <span className="badge-gold text-xs px-4 py-1">
              ✨ India's #1 Wedding Vendor Marketplace
            </span>
          </div>
          <h1
            style={{
          ...
          >
            Discover top-rated photographers, venues, caterers & more for your
            dream day. 10,000+ couples trust WeddingBliss.
          </p>

          <div className="flex flex-wrap gap-4 justify-center mb-10">
            <Link to="/vendors" className="btn-gold text-base px-8 py-3">
              Browse Vendors
            </Link>
            <Link
              to="/contact"
              className="btn-outline-white text-base px-8 py-3"
            >
              Learn More
            </Link>
          </div>
          ...
          <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-2xl p-2 flex gap-2">
            ...
            <Link
              to="/vendors"
              className="btn-primary text-sm px-6 py-2 rounded-lg whitespace-nowrap"
            >
              Search
            </Link>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-10 text-sm">
            {[
              ...
              <div key={label} className="text-center">
                ...
                <div style={{ color: "#f0e6e9", fontSize: "0.8rem" }}>
                  {label}
                </div>
              </div>
            ))}
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <p className="section-subtitle">
            Find the perfect vendor type for your wedding
          </p>
      ...
      <section id="portfolio" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="section-subtitle">
            Hand-picked top-rated professionals for your big day
          </p>
          ...
          <div className="text-center mt-10">
            <Link
              to="/vendors"
              className="btn-outline px-10 py-3 inline-flex items-center gap-2"
            >
      ...
      <section className="py-20 px-4" style={{ backgroundColor: "#FFF7FA" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="badge-gold mb-4 inline-block tracking-widest uppercase">
              Planning Packages
            </span>
            <h2 className="section-title">Choose Your Perfect Plan</h2>
            <p className="section-subtitle">
              Transparent pricing for every wedding dream
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card p-8 flex flex-col bg-white border border-gray-100 relative group overflow-hidden">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                {[
                  "Dedicated Virtual Planner",
                  "Up to 3 Vendor Bookings",
                  ...
                  >
                    <CheckCircle size={16} className="text-[#66D0BC]" />{" "}
                    {feature}
                  </li>
                ))}
              </ul>
              <Link
                to="/enquiry"
                className="btn-outline w-full text-center py-3 group-hover:bg-[#FF3E9B] group-hover:text-white transition-all duration-300"
              >
                Book Essential
              </Link>
            </div>
            ...
            <div className="card p-8 flex flex-col bg-[#FF3E9B] text-white shadow-2xl relative group transform md:-translate-y-4 hover:-translate-y-6 transition-transform duration-500">
              <div className="absolute top-4 right-4 animate-pulse">
                <span className="bg-[#66D0BC] text-[#1a1a1a] text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                  Most Popular
                </span>
              </div>
              <h3
              ...
              <p className="text-[#f0e6e9] text-sm mb-6">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                {[
                  ...
                  "Unlimited Vendor Bookings",
                  "Advanced Budget & RSVP Tool",
                  "Theme & Decor Styling",
                  "24/7 Priority Support",
                ].map((feature, i) => (
                  <li
                    key={i}
                    className="flex items-center gap-3 text-sm text-[#f0e6e9]"
                  >
                    <CheckCircle size={16} className="text-[#66D0BC]" />{" "}
                    {feature}
                  </li>
              ...
              <Link
                to="/enquiry"
                className="btn-gold w-full text-center py-3 shadow-lg hover:scale-105 transition-transform duration-300"
              >
                Book Premium
              </Link>
            </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="section-subtitle">
            Three simple steps to your perfect wedding day
          </p>
            ...
            {[
              {
                ...
                desc: "Explore thousands of verified vendors filtered by category, location, and budget to match your vision.",
              },
              {
                num: "02",
                icon: "📋",
                title: "Compare & Shortlist",
                desc: "Read real reviews, compare packages, save favourites and build your perfect wedding team.",
              },
              {
                num: "03",
                icon: "💍",
                title: "Book & Celebrate",
                desc: "Send enquiries, confirm bookings, and enjoy your dream wedding with confidence and ease.",
              },
            ].map((step) => (
      ...
      <section id="reviews" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="section-subtitle">
            Thousands of couples have found their perfect wedding vendors
            through us
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div key={i} className="card p-8">
                <div className="flex items-center gap-3 mb-4">
                  {[1, 2, 3, 4, 5].map((s) => (
                    <span
                      key={s}
                      style={{ color: "#66D0BC", fontSize: "1.1rem" }}
                    >
                      ★
                    </span>
                  ))}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: "0.75rem", color: "#FF3E9B" }}>
                      {t.date}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 items-center bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div className="flex-1 text-center md:text-left md:pl-8">
            ...
            <p className="text-gray-500 mb-6">
              We'd love to meet you and discuss your dream wedding in person.
            </p>
            <div className="flex items-start gap-4 mb-4 justify-center md:justify-start text-gray-700">
              ...
              <div className="text-sm">
                <strong>WeddingBliss HQ</strong>
                <br />
                123 Wedding Lane, Bandra West
                <br />
            ...
            <Link
              to="/contact"
              className="btn-primary mt-4 py-2 px-8 inline-block"
            >
              Get Directions
            </Link>
          </div>
          <div className="flex-1 w-full rounded-xl overflow-hidden shadow-inner h-64 relative bg-gray-200">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://maps.googleapis.com/maps/api/staticmap?center=Mumbai,India&zoom=11&size=600x300&maptype=roadmap')",
              }}
            ></div>
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, #3A8B95, #FF3E9B)" }}
      >
        <div className="max-w-3xl mx-auto">
          ...
          >
            Join 10,000+ couples who planned their perfect wedding with
            WeddingBliss.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/vendors" className="btn-gold px-10 py-3">
              Browse Vendors
            </Link>
            <Link to="/login" className="btn-outline-white px-10 py-3">
              Create Free Account
            </Link>
          </div>
        </div>
